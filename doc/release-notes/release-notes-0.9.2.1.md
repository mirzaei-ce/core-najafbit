Najafbit Core version 0.9.2.1 is now available from:

  https://najafbit.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 NBT to 0.01 NBT
...
- Fix "Start najafbit on system login"
