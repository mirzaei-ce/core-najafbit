Najafbit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/najafbit/files/Najafbit/najafbit-0.5.4/
...
http://gitorious.org/najafbit/najafbitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Najafbit-Qt notifications under Growl 1.3.
Increase required age of Najafbit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxNajafbit properly when installing Najafbit-Qt over it. (Windows)
