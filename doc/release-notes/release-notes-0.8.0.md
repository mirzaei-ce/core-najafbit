Najafbit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/najafbit/files/Najafbit/najafbit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Najafbit
...
New/changed settings (command-line or najafbit.conf file)
--------------------------------------------------------
