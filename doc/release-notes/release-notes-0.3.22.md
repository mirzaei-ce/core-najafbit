Download URL: https://sourceforge.net/projects/najafbit/files/Najafbit/najafbit-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 NBT fee schedule (users still pay 0.01 NBT per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #najafbit00 - #najafbit99
