Najafbit Core version 0.9.4 is now available from:

  https://najafbit.org/bin/0.9.4/
...
this update is incompatible with the Najafbit system and could lead to consensus
forks.

Najafbit Core released binaries from https://najafbit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~najafbit/+archive/ubuntu/najafbit
- A third-party or self-compiled Najafbit Core

upgrade to Najafbit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
