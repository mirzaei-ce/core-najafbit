...
#if defined(NDEBUG)
# error "Najafbit cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Najafbit Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s NBT additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("najafbit-scriptch");
