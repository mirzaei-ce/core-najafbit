...
#ifndef NAJAFBIT_TEST_SCRIPTNUM10_H
#define NAJAFBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Najafbit Core 0.10.0, for cross-comparison.
 */
public:
