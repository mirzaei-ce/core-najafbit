...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/najafbit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Najafbit Core"),
     ...
     * override -datadir in the najafbit.conf file in the default data directory
     * (to be consistent with najafbitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
