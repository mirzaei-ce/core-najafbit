...
#ifndef NAJAFBIT_QT_NAJAFBITUNITS_H
#define NAJAFBIT_QT_NAJAFBITUNITS_H
...
/** Najafbit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class NajafbitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit NajafbitUnits(QObject *parent);

    /** Najafbit units.
      @note Source: https://en.najafbit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        NBT,
...
typedef NajafbitUnits::Unit NajafbitUnit;

#endif // NAJAFBIT_QT_NAJAFBITUNITS_H
